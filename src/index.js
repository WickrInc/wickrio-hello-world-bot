...
const responseMessageList = [
  'Hey there! Thanks for messaging me! I have a few helpful but random tips I can share in response to your messages, ' +
    'so please bear with me☺ If you have more questions than I have answers, head to Settings > Support in Wickr Pro. ' +
    'Way to go to protect your privacy!',

  'JavaScript API:\n\n' +
    'Have an idea for a cool integration for wickr? you can now implement it using our brand new Node.js API ' +
    'It is also possible to code integrations in different languages using our WickrIO REST API. For more information visit https://github.com/WickrInc\n\n',
  ...
  'Fun fact\n' +
    'Wickr is used in over a 150 countries, and has over 600,000 registered users. ' +
    'Congrats on being one of them, enjoy your security and privacy.',

  'Did you know that Wickr Pro has a Hubot integration?\n\n' +
    'When you add a bot, just select the hubot integration option from the menu.' +
    'With Hubot you get access to cool features such as Giphy and pug bombs and exisiting Wickr Integrations such as Slack, Uber and Salesforce Chatter.' +
    'You can also create your own custom integrations with Hubot or choose from hundreds of existing integrations and scripts available online on npmjs.com.\n\n',

  'Sending files on Wickr Pro:\n\n' +
    'You can now send photos, videos, and other ephemeral files up to 5GB via End-to-End encryption. Secure Screenshare & File Upload This feature supports collaboration ' +
  ...
  'Verification\n\n' +
    ...
    'verification request to establish trust between your Wickr Pro accounts.\n\n' +
    'Check out our blog on this: https://medium.com/cryptoblog/key-verification-in-secure-messaging-bd93a1bf3d40',

  'Passwords\n\n' +
    "Important to know: there is no password reset on Wickr Pro – we don't know who you are which prevents us from " +
...
function listen(msg) {
  ...
  const parsedMessage = bot.parseMessage(msg)
  if (!parsedMessage) {
    return
  }
  const {
  ...
  if (user === undefined) {
    ...
    wickrUser = new WickrUser(userEmail, {
      index: 0,
      personal_vGroupID: personalvGroupID,
      command: '',
      argument: '',
    })
